...
type RawRow = { id: string; status: Row['status']; score: number | null; quests?: QuestObj | QuestObj[] | null };
...
export default function MyWork() {
  ...
  return (
    <div className="space-y-6">
      ...
      {rows.length === 0 && <p>No assignments yet. <Link className="text-blue-600 underline" href="/app">Pick a quest</Link>.</p>}
