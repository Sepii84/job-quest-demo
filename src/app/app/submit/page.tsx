...
export default function Submit() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    // 2) Flip the assignment status to 'submitted'
    ...
    if (updErr) {
      // If RLS blocks updates, you’ll see it here.
      return alert('Submitted, but failed to flag as submitted: ' + updErr.message);
    }

    alert('Submitted! Your work is now in the review queue.');
    router.push('/app'); // or router.push('/admin/grade') if you're the grader
  };
